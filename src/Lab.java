...
public class Lab {
    ...
    int get_lab_number() { return lab_number; }

    boolean isOccupied() { return is_occupied; }

    String get_lab_type() { return lab_type; }

    void set_is_occupied(boolean occupied) { is_occupied = occupied; }
}
