...
public class Main {
    public static void main(String[] args) {
        ...
        tt.makeTimeTable();
        tt.printTimeTable(0, "CSE-2nd-sem.png");
        tt.printTimeTable(1, "CSE-4th-sem.png");
        tt.printTimeTable(2, "CSE-6th-sem.png");
        ...
        tt2.makeTimeTable();
        tt2.printTimeTable(0, "DSAI-2nd-sem.png");
        tt2.printTimeTable(1, "DSAI-4th-sem.png");
        tt2.printTimeTable(2, "DSAI-6th-sem.png");
    }
}
